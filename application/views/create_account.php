			...
			<div class="d-flex flex-column flex-column-fluid flex-lg-row">
				...
				<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
					...
					<div class="d-flex flex-center flex-lg-start flex-column">
						...
						<!--end::Logo-->
						<!--begin::Title-->
						<h2 class="text-white fw-normal m-0">Car Maintenance Reminder System</h2>
						<!--end::Title-->
					</div>
					<!--begin::Aside-->
				</div>
						...
						<div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" action="#">
								...
								<div class="text-center mb-11">
									...
									<!--end::Title-->
									<!--begin::Subtitle-->
									<div class="text-gray-500 fw-semibold fs-6">Car Maintenance Reminder System</div>
									<!--end::Subtitle=-->
								</div>
								<!--begin::Heading-->
								<!--begin::Login options-->
								...
								<div class="fv-row mb-8">
									<!--begin::Email-->
									<select name="user_type" class="select2-selection select2-selection--single form-select fw-bold">
										<option value="">Register Account as a ...</option>
										<option value="1">User</option>
										<option value="2">Workshop Owner</option>
									</select>
									<!--end::Email-->
								</div>
								<!--begin::Input group-->
